...
![2024 年 3 月 30 日 10:00 - 11:40，蚂蚁24年春招工程研发笔试。](./assets/post_images/image-20240329212240645.png)

总限时 100 分钟，共 100 分。

前面是 10 道单选题、5 道不定项选择题。其中有几道是语言相关的，可以自己选做 Java/C++，我这里选的是 Java。

![前面是 10 道单选题、5 道不定项选择题。其中有几道是语言相关的，可以自己选做 Java/C++，我这里选的是 Java。](./assets/post_images/image-20240330132056356.png)
...
![Q4.](./assets/post_images/image-20240330141922644.png)
...
![在一个旅游规划中，不同景点之间有不同的距离，可以用带权连通无向图G=（V，E）表示旅游路线，其中](./assets/post_images/image-20240330152137289.png)
...
![关于设计模式的说法，哪些正确？](./assets/post_images/image-20240330153748817.png)
