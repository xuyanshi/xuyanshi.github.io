...
featured: false
draft: false
tags: [algorithm, array, backtracking, bit manipulation, interview, math]
description: "2024 年 4 月 28 日 14:00 - 15:40，阿里云 2025 届工程研发笔试。"
---
...
- 选择1 ≤ i＜n，将a*i 和a* (i+1) 合并为一个数字，结果为 a*i & a*(i+1)。（&表示按位与运算）
- 选择1 ≤ i＜n，将a*i 和a* (i+1) 合并为一个数字，结果为 a*i \| a*(i+1)。（ 竖线表示按位或运算）
